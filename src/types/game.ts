...
export const GAMES: Game[] = [
  ...
  { id: 'endless-driver', title: 'Endless Driver', emoji: 'E', description: 'Гонки без конца', category: 'modern', tags: ['современные','гонки'], players: '1', isNew: true, color: '#00f3ff' },
  { id: 'aim-trainer', title: 'Aim Trainer', emoji: 'N', description: 'Прокачай меткость', category: 'modern', tags: ['современные','стрельба'], players: '1', isNew: true, color: '#ff3355' },
  { id: 'space-invaders', title: 'Space Invaders', emoji: 'V', description: 'Отражай атаку пришельцев', category: 'modern', tags: ['современные','аркада'], players: '1', isNew: true, color: '#00ff88' },
  { id: 'ninja-dash', title: 'Ninja Dash', emoji: 'X', description: 'Быстрые рефлексы ниндзя', category: 'modern', tags: ['современные','экшн'], players: '1', isNew: true, color: '#ff2d95' },
  { id: 'rocket-escape', title: 'Rocket Escape', emoji: 'R', description: 'Улетай от опасности', category: 'modern', tags: ['современные','аркада'], players: '1', isNew: true, color: '#ff3355' },
  { id: 'zombie-survival', title: 'Zombie Survival', emoji: 'Z', description: 'Выживи в апокалипсисе', category: 'modern', tags: ['современные','экшн'], players: '1', isNew: true, color: '#00ff88' },
  { id: 'doodle-jump', title: 'Doodle Jump', emoji: 'J', description: 'Прыгай всё выше', category: 'modern', tags: ['современные','аркада'], players: '1', isNew: true, color: '#00f3ff' },
  { id: 'frogger', title: 'Frogger', emoji: 'G', description: 'Переправь лягушку через дорогу', category: 'modern', tags: ['современные','аркада'], players: '1', isNew: true, color: '#00ff88' },
  { id: 'asteroids', title: 'Asteroids', emoji: 'W', description: 'Взрывай астероиды', category: 'modern', tags: ['современные','аркада'], players: '1', isNew: true, color: '#ff2d95' },
]
