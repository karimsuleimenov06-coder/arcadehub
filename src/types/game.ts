...
export const GAMES: Game[] = [
  ...
  { id: 'pong', title: 'Pong', emoji: 'P', description: 'Ретро-теннис с другом или ИИ', category: 'classic', tags: ['классика','спорт'], players: '2', color: '#00ff88' },
  { id: 'tictactoe', title: 'Крестики-нолики', emoji: 'O', description: 'Обыграй ИИ или сыграй с другом', category: 'classic', tags: ['классика','стратегия'], players: '2', color: '#00f3ff' },
  ...
  { id: 'poker', title: 'Покер', emoji: 'K', description: 'Виртуальные фишки, без реальных денег', category: 'modern', tags: ['современные','карты'], players: '2-6', isOnline: true, color: '#ff2d95' },
